function supplierPlastic() 
{
    ...
    if (quantity > 0) 
	{
        ...
        let price2 = (quantity * 4.50).toFixed(2);
        let price3 = (quantity * 4).toFixed(2);
        if (quantity >= 16 && quantity <= 25) 
		{
            let priceDiscount1 = price1 - (price2 * 0.10);
            let priceDiscount2 = price2 - (price2 * 0.15);
            let priceDiscount3 = price3 - (price3 * 0.13);
		...
		else 
		{
            if (quantity >= 11 && quantity <= 15) 
			{
                ...
                let priceDiscount3 = price3 - (price3 * 0.13);
                document.getElementById('price').innerHTML = "Best price: " + priceDiscount3.toFixed(2) + "€";
                document.getElementById('results').innerHTML = "<h4><ul><li><b>Supplier 1</b> can fulfill the request for " + priceDiscount1.toFixed(2) + "€. Fast delivery.<br></li><br><li><b>Supplier 2</b> is not prompted because it does not have enough stock quantity available. </li><br><li><b>Supplier 3</b> can fulfill the request for " + priceDiscount3.toFixed(2) + "€ this is the cheapest one so it should be highlighted.</ul></h4>";
            } 
			else 
			{
				...
				else 
				{
					...
					else 
					{
                        if (quantity <= 4) 
						{
                            ...
                            let priceDiscount3 = price3;
                            document.getElementById('price').innerHTML = "Best price: " + priceDiscount3 + "€";
                            document.getElementById('results').innerHTML = "<h4><ul><li><b>Supplier 1</b> can fulfill the request for " + priceDiscount1 + "€. Fast delivery.<br></li><br><li><b>Supplier 2</b> can fulfill the request for " + priceDiscount2 + "€. </li><br><li><b>Supplier 3</b> can fulfill the request for " + priceDiscount3 + "€ this is the cheapest one so it should be highlighted.</ul></h4>";
                        } 
						else 
						{
